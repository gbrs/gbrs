...
* [x] покопаться в GA4: окончательный переход уже близок!;
* [x] подсоединить Яндекс.Метрику к DataLens;
* [x] подсоединить Google Analytics к Looker Studio;
...
* [ ] углубиться в статистику A/B-экспериментов.
