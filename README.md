...
Хотя моя работа не связана напрямую со сферой IT. Я - сотрудник отдела внешней кооперации. Создал сайт компании. Отвечаю за наполнение сайта, SEO-оптимизацию (вывел сайт в первую-вторую десятку по многим важным для нас запросам). За мной поддержка локальной сети и обслуживание ПК нашей небольшой компании. Оформление счетов, отгрузочных документов в 1С, ЭДО. Сбор информации, формирование и поддержание в актуальном состоянии базы данных потенциальных подрядчиков.


В данный момент прохожу курсы: Симулятор SQL, Регулярные выражения в Python.
