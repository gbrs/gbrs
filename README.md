...
Мой институтский курс Fortran 4 :) уже был позабыт. И я решил посмотреть курс по Python.  

И понеслось...  

Что-то в этом зацепило и "очнувшись" обнаруживаю пройденными курсы по 
SQL и статистике, Linux и GIT, машинному обучению и нейросетям, Pandas и иже с ним.
